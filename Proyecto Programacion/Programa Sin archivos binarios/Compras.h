...
Parámetros de Entrada(E) y Salida(S): (S)ArchivoCompra- Archivo que se va crear.
...
Parámetros de Entrada(E) y Salida(S): (S)ArchivoCompra- Contiene los datos a extraer.
...
Parámetros de Entrada(E) y Salida(S): (S)ArchivoCompra- Archivo donde se guardaran las compras.
