...
/*
Nombre: proveedores
Objetivo: Submenú que contiene las funciones de altas, bajas, modificaciones y consulta 
    de un prooveedor.
Parámetros de Entrada(E) y Salida(S): (S)pProveedor- Donde se llevaran acabo las funciones 
...
Objetivo: Menú que permite realizar la alta de un proveedor.
Parámetros de Entrada(E) y Salida(S): (S)pProveedor - donde se guardará el proveedor dado de alta
*/
...
Objetivo: Menú que permite realizar la baja de un proveedor.
Parámetros de Entrada(E) y Salida(S): (S)pProveedor- donde se guardará el proveedor dado de baja.
*/
...
Objetivo: Menú que permite realizar la consulta de la información de un proveedor.
Parámetros de Entrada(E) y Salida(S): (E)pProveedor - contiene la información del proveedor que se
    consultará. 
*/
...
Objetivo: Menú que permite realizar la modificación de un proveedor.
Parámetros de Entrada(E) y Salida(S): (S)pProveedor - contiene la información que se modificará
    del proveedor.  
*/
...
Parámetros de Entrada(E) y Salida(S): (E)pProveedor - donde se llevará acabo la liberación de
    memoria.
*/
...
Parámetros de Entrada(E) y Salida(S): (S)pProveedor - donde se registran los datos del proveedor.
*/
...
Parámetros de Entrada(E) y Salida(S): (E)pProveedor - donde se realizará la búsqueda del proveedor.
    (E)Nombre - Nombre del proveedor que se desea buscar en la lista.
Tipo de retorno: TpProveedor - contiene la ubicación dentro de la lista donde se encuentra
    el proveedor.
*/  
...
Parámetros de Entrada(E) y Salida(S): (E)pProveedor- contiene la informacion de los proveedores.
*/
...
Parámetros de Entrada(E) y Salida(S): (S)pProveedor - donde se llevará acabo la eliminación
    del proveedor.
...
Objetivo: Modificar información de un proveedor.
Parámetros de Entrada(E) y Salida(S): (S)pProveedor - contiene la información del proveedor
    a modifcar.
...
Parámetros de Entrada(E) y Salida(S): (E)aFecha - contiene el arreglo de las fechas a mostrar.
...
Parámetros de Entrada(E) y Salida(S): (S)ArchivoProve - Archivo que se va crear.
    (S)pProveedor - Donde se van a guardar los datos extraídos del archivo.
*/
...
Parámetros de Entrada(E) y Salida(S): (S)ArchivoProve- Contiene los datos a extraer.
...
Parámetros de Entrada(E) y Salida(S): (S)ArchivoProve - Archivo donde se guardaran los proveedores.
