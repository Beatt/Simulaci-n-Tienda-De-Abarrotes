...
Parámetros de Entrada(E) y Salida(S): (S)pProducto- donde se guardaran los datos del producto.
*/
...
Parámetros de Entrada(E) y Salida(S): (E)pProducto - donde se realizará la búsqueda del producto.
    (E)eCodigoProd- Producto que se buscará en la lista, la búsqueda se realiza por el 
    código del producto(ID) del producto.
Tipo de retorno: TpProducto - contiene la ubicación dentro de la lista donde se encuentra
    el producto.
*/               
...
Parámetros de Entrada(E) y Salida(S): (S)pProducto - donde se llevará acabo la eliminación del producto.
...
Parámetros de Entrada(E) y Salida(S): (S)pProducto - contiene la información del 
    producto a modificar.
    (E)eCodigoProd - código(ID) del producto a modificar.
*/
...
Parámetros de Entrada(E) y Salida(S): (E)pProducto - contiene los productos que se mostraran
    en pantalla.
*/
...
Parámetros de Entrada(E) y Salida(S): (E)pProducto - donde se llevará acabo la liberación de
    memoria.
*/
...
Parametros de Entrada(E) y Salida(S): (S)ArchivoProd - Archivo que se va crear.
    (S)pProducto - Donde se van a guardar los datos extraídos del archivo.
*/
...
Parámetros de Entrada(E) y Salida(S): (S)ArchivoProd- Contiene los datos a extraer.
...
//Inicio
    ...
    do
    {
        //Devuelve el número de elementos leídos del archivo
...
Parámetros de Entrada(E) y Salida(S): (S)ArchivoProd - Archivo donde se guardaran los productos.
